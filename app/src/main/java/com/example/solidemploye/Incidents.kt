package com.example.solidemploye

import android.os.Build
import androidx.annotation.RequiresApi
import com.example.solidemploye.Constants.Companion.MINIMUM_SENIORITY_FREE_RETARDANT
import com.example.solidemploye.Constants.Companion.NUMBER_OF_RETARDANT_EQUIVALENT_TO_ONE_ABSENCE
import java.time.LocalDate

data class Incidents (val employee: Employee,
                      val currentSchedule: Horario,
