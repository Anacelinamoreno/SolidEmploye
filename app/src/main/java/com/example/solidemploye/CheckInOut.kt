...
import com.example.solidemploye.Constants.Companion.RETARDANT_LOWER_LIMIT
import com.example.solidemploye.Constants.Companion.RETARDANT_UPPER_LIMIT
...
data class CheckInOut(
    ...
    fun isRetardant(currentSchedule: Horario,
